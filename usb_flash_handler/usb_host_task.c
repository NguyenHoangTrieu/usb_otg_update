...
esp_err_t usb_cdc_send_data(usb_device_t *dev, const uint8_t *data, size_t len,
  ...
  transfer->bEndpointAddress = 0x82; // endpoint_out needs to be initialized from descriptor
...
esp_err_t usb_cdc_receive_data(usb_device_t *dev, uint8_t *data, size_t max_len,
  ...
  transfer->bEndpointAddress = 0x82; //  needs to be initialized from descriptor
